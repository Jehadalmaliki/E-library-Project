...
<div class="card mb-4">
  ...
  <form class="card-body" action="/save_books" method="POST">
    ...
    <div class="row g-3">
      ...
      <div class="col-md-6">
        <label class="form-label" for="multicol-username">بدايه التخفيضات</label>
        <input name="phone" type="text" id="multicol-username" class="form-control" placeholder="john.doe" />
      </div>
      <div class="col-md-6">
        <label class="form-label" for="multicol-username"> نهايه التخفيضات</label>
        <input name="address" type="text" id="multicol-username" class="form-control" placeholder="john.doe" />
      </div>
      <div class="col-md-6">
        <label class="form-label" for="multicol-username"> كل  الكتب</label>
