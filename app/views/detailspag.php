...
<head>
    ...
    <link rel="stylesheet" href="assets1/css/detailscss.css">
        ...
        <header class="item1">
          <div id="menu-icon" class="fas fa-bars"></div>
                <nav>
                    <div class="ul">
                <ul>
                    <li><a id="myBtn" ><img src="assets1/img/svg/svgexport-1.svg">ادخل لحسابك وسجل الان </a></li>
                    <li><a href="library.php"><img src="assets1/img/svg/svgexport-2.svg">الرئيسيه</a></li>
                    <li><a ><img src="assets1/img/svg/svgexport-3.svg">من نحن</a></li>
                    <li><a ><img src="assets1/img/svg/svgexport-4.svg">اتصل بنا</a></li>
                    <li><a ><img src="assets1/img/svg/vgexport-5.svg">المساعدة</a></li>
                    <li><a ><img src="assets1/img/svg/vgexport-24.svg">صحيفة الاسبوعية</a></li>
                    <li><a ><img src="assets1/img/svg/vgexport-28.svg">اليمن</a></li>
                    <li><a  ><img src="assets1/img/svg/vgexport-14.svg" onclick="togglestyle()">English</a></li>    
                </ul>
            </div>
             ...
             <div class="search" id="search">
                <div class ="icon1"> <img src="img\svg\img.png" ></div>
                 ...
                 <div class ="icon"> <a href="/cart"><div class="span">0</div><img src="img\svg\svgexport-50.svg"></a></div>
             </div>
            </nav>
         </header>
         <!-- header end -->
    ...
    <span class="close">&times;</span>
         ...
         <section class="item3">
          ...
          <div class="mySlides fade">
            ...
            <img src="assets1/img/sliderassets1/s/slider_img2.webp" style="width:100%">
            <div class="text"></div>
          </div>
              ...
              <div class="box-container">
                    ...
                    <div class="box " id="border">
                      ...
                      <div class="content">
                        <div class="row">
                          <div class="column">
                            <img src="assets1/img/b4.jpg"  style="width:100% ; border: 1px solid blue;border-radius: 4px;" onclick="openModal();currentSlide(1)" class="hover-shadow cursor">
                          </div>
                        ...
                        <div id="myModal3" class="modal3">
                          ...
                          <div class="modal-content3">
                            ...
                            <div class="mySlides1">
                              ...
                              <img src="assets1/img/b4.jpg" style="width:100%">
                            </div>
                        
                            <div class="mySlides1">
                              <div class="numbertext">2 / 4</div>
                              <img src="assets1/img/b3.jpg" style="width:100%">
                            </div>
                        
                            <div class="mySlides1">
                              <div class="numbertext">3 / 4</div>
                              <img src="assets1/img/b2.jpg" style="width:100%">
                            </div>
                            ...
                            <div class="column">
                              <img class="demo cursor" src="assets1/img/b4.jpg" style="width:100%" onclick="currentSlide1(1)" alt="الصفحة الرئيسية">
                            </div>
                            <div class="column">
                              <img class="demo cursor" src="assets1/img/b3.jpg" style="width:100%" onclick="currentSlide1(2)" alt="من الخلف">
                            </div>
                            <div class="column">
                              <img class="demo cursor" src="assets1/img/b2.jpg" style="width:100%" onclick="currentSlide1(3)" alt="المؤلف  ">
                            </div>
                            <div class="column">
                              <img class="demo cursor" src="assets1/img/b4.jpg" style="width:100%" onclick="currentSlide1(4)" alt=" المحتوى">
                            </div>
                          </div>
                        </div>
                   </div>    
                  ...
                  <div class="box c">
                    ...
                    <div class ="inside" >
                      <div class="lefty">
                       <div class="a"> <img src="assets1/img/svg/svgexport-3.svg"> تسوق امن <img src="assets1/img/svg/svgexport-2.svg"></div>
                        <div class="a"><img src="assets1/img/svg/svgexport-4.svg"> تسوق امن <img src="assets1/img/svg/svgexport-5.svg"></div>

                      </div>
                      <div class="righty">
                        <img src="assets1/img/svg/svgexport-3.svg"> تسوق امن <img src="assets1/img/svg/svgexport-3.svg">
                      </div>
                    </div>  
                    <div class="end" >
