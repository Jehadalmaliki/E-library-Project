    ...
    <div class="table-responsive text-nowrap">
      <table class="table table-bordered">
        ...
        <tbody>
         ...
         <?php foreach($params as $user_payment){?>
          <tr>
            
            <td><?= $user_payment['user_id'];?></td>
            <td><?= $user_payment['payement_id'];?></td>
     
            <td>
            <?php if($user_payment['is_active']==1) {?>    
            ...
            <td>
            <a href="/edit_user_payment/<?php echo $user_payment['id'];?>" class="btn btn-icon btn-outline-dribbble">
