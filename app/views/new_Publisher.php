...
<div class="card mb-4">
  ...
  <form class="card-body" action="/save_Publishers" method="POST" enctype="multipart/form-data">
    <h6>تفاصيل الناشر</h6>
    <div class="row g-3">
      <div class="col-md-6">
      ...
      <div class="col-md-6">
        <label class="form-label" for="multicol-username"> تلفون اخر</label>
      ...
      <div class="col-md-6">
        <label class="form-label" for="multicol-username"> فاكس</label>
      ...
      <div class="col-md-6">
        <label class="form-label" for="multicol-email">صورة دار النشر </label>
