...
<div class="app-brand demo ">
  <a href="index-2.html" class="app-brand-link">
    ...
    <span class="app-brand-text demo menu-text fw-bolder ms-2">المكتبه الالكترونيه</span>
  </a>
...
<ul class="menu-inner py-1">
 ...
 <li class="menu-item">
  ...
  <li class="menu-item">
    <a href="javascript:void(0);" class="menu-link menu-toggle">
      <i class="menu-icon tf-icons bx bx-user"></i>
      <div data-i18n="اداره الصلاحيات"> </div>
    </a>
    <ul class="menu-sub">
    <li class="menu-item">
        <a href="/new_role" class="menu-link">
          <div data-i18n="اضافه صلاحيه"> </div>
        </a>
      </li>
      <li class="menu-item">
        <a href="/roles" class="menu-link">
        <div data-i18n="عرض الصلاحيات"> </div>
        </a>
      </li>
      <li class="menu-item">
        <a href="/edit_role" class="menu-link">
        <div data-i18n="تعديل الصلاحيات"> </div>
        </a>
      </li>
    </ul>
  </li>
...
<li class="menu-item">
    ...
    <li class="menu-item">
      ...
      <li class="menu-item">
        <a href="/edit_user" class="menu-link">
        <div data-i18n="تعديل المستخدم"> </div>
        </a>
      </li>
    </ul>
  </li>
